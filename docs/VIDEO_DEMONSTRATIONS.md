...
This page contains video demonstrations of the SimShip Agent features and workflows.
...
## Intelligent Discovery: Structured Metadata Search
...
**Note:** These videos are hosted directly in the repository. If you experience playback issues, you can download them from the [videos folder](https://github.com/derricksobrien/simship-agent-docs/tree/main/docs/videos).